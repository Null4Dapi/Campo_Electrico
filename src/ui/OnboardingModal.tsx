...
const SLIDES = [
  {
    title: 'Manipulación 3D',
    description: 'Navega libremente por la escena usando el ratón. Usa clic izquierdo para rotar, clic derecho para paneo, y la rueda para hacer zoom.',
    image: '/onboarding/onboarding_camera_controls_1780963682668.webp'
  },
  {
    title: 'Copiloto IA',
    description: 'Presiona "/" en el chat para acceder a comandos rápidos, o pide en lenguaje natural que el asistente cree dipolos, limpie la escena o cambie la vista.',
    image: '/onboarding/onboarding_ai_copilot_1780963693278.webp'
  },
  {
    title: 'Agregar Cargas',
    description: 'Añade cargas puntuales positivas o negativas al espacio y observa cómo interactúan los campos eléctricos en tiempo real.',
