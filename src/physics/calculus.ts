...
export const SOFTENING = 1e-10; // Prevención de singularidades (softening factor)
 ...
 * Retorna el vector dirección (normalizado para visualización) y la magnitud real en N/C.
 */
 ...
 * Usado para el algoritmo Marching Cubes y superficies equipotenciales.
 */
